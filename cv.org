...
Also worked architecting system to migrate existing cloud save data on
iOS to new format while maintaining high confidence that no data would
be lost.
...
Lead software engineer on four iOS and Android projects. (C#/C++/Unity3D/Cocos2DX)
...
* Language Skills
I am a native English speaker and have learned other languages in the
past. At this point I can still understand most German, Dutch and
French, however through lack of use I am not particularly fluent in
speaking it. I have also begun learning Russian, however have not yet
progressed beyond a beginner level.
