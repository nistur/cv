...
# #########################################################################
# This is a bit of a hack, so that for man-page export, it will add the
# email address to the contact information, rather than "the details above"
# which will be output for PDF
# #########################################################################
...
architecture. Also worked on a small R&D team exploring different project ideas using a variety of
