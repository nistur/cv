#+OPTIONS: toc:nil H:10 tex:t date:nil author:nil
...
#+LATEX_HEADER: \lhead{} \rhead{} \chead{}
#+LATEX_HEADER: \rfoot{\href{mailto:philipp@geyer.co.uk}{philipp@geyer.co.uk}}
#+LATEX_HEADER: \cfoot{\color{watermark-gray}NO PERMISSION IS GIVEN TO EDIT THIS DOCUMENT}
...
+ Experience using a variety of game engines and frameworks including
  Unity3D, Unreal 4, and Marmalade.
+ Comfortable with a wide range of progreamming languages including
  C/C++, Objective C, C#, Java, Lua, Python, Lisp, ASM.
+ Experience setting up cloud infrastructure using services such as AWS.

* Experience
#+LATEX: \hfill
#+LATEX: \vspace{-6mm}
https://philippgeyer.co.uk/cv/00.html
#+LATEX: \break
...
+ HotWheels Ultimate Garage (C#/Unity3D)
...
Acted as senior programmer on existing project, working to
...
+ Lara Croft and the Guardian of Light (C++)
+ Transformers 3: Dark of the Moon (C++)
+ Call of Duty Black Ops: Zombies (C++)
+ Backbreaker 2: Vengeance (C++)
+ Wipeout (C#/Unity3D)
+ Marmalade Juice (C++/Obj-C)
...
2006 until 2010 BSC (Hons) Computer Games Technology
